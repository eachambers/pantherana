...
# We first take our LD-pruned vcf file which only contains samples for which we have coordinates 
# "forreri_n92_ldp.recode.vcf"
# Then we need to create a diffs file which contains a matrix of average pairwise genetic 
# differences
...
# The above will generate two files: .dist which contains the distance matrix itself and 
# .dist.id which contains the corresponding sample IDs
